...
# ESTE CÓDIGO GENERA LAS IMÁGENES DE LAS SEÑALES A PARTIR DE LOS ARCHIVOS TXT
# EN LA CARPETA "samples" Y LAS GUARDA EN "images_python".
# Asegurarse de que las carpetas existan y contengan los archivos necesarios.

folder = "samples"
output_folder = "images_python"
